            ...
            <div className="container mx-auto px-4 py-16">
                ...
                >
                    ...
                    >
                        <Link to="/analysis">
                            <motion.button 
                                className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition-all"
                ...
                <motion.div 
                    className="mt-24 bg-white p-8 rounded-2xl shadow-lg max-w-4xl mx-auto"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                >
                    <div className="flex flex-col md:flex-row items-center">
                        <div className="md:w-3/5 md:pr-8">
                            <h2 className="text-3xl font-bold text-gray-800 mb-4">Ready to analyze your code?</h2>
                        ...
                        <div className="md:w-2/5 mt-6 md:mt-0">
                            <div className="p-1 bg-gray-100 rounded-lg">
                                <svg className="w-full h-auto" viewBox="0 0 200 160" fill="none">
                                    <rect width="200" height="160" rx="8" fill="#EBF2FE"/>
                                    <rect x="20" y="20" width="160" height="20" rx="4" fill="#D1E1FD"/>
                                    <rect x="20" y="50" width="160" height="20" rx="4" fill="#D1E1FD"/>
                                    <rect x="20" y="80" width="100" height="20" rx="4" fill="#D1E1FD"/>
                                    <rect x="20" y="110" width="160" height="30" rx="4" fill="#3B82F6"/>
                                </svg>
                            </div>
                        </div>
                    </div>
